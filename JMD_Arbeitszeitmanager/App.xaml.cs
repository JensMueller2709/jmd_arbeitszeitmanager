...
using JMD_Arbeitszeitmanager.Core.Contracts.Services;
using JMD_Arbeitszeitmanager.Core.Services;
using JMD_Arbeitszeitmanager.Models;
using JMD_Arbeitszeitmanager.Services;
using JMD_Arbeitszeitmanager.Services.Database;
using JMD_Arbeitszeitmanager.Views;

using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;

namespace JMD_Arbeitszeitmanager
{
    ...
    public partial class App : Application
    {
        ...
        private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
        {
            ...
            services.AddSingleton<IDbSchicht, DbSchicht>();
            services.AddSingleton<ISchichtService, SchichtService>();
            services.AddSingleton<IWorkingTimeService, WorkingTimeService>();
            services.AddSingleton<IDbTask, DBTask>();
